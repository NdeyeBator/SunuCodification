    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION AGENT</center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('agents.store') }}">
                      {{ csrf_field() }}
                      <div class="form-group">
                          <label for="name" class="col-md-4 control-label">Numero Agent</label>
                          <div class="col-md-6">
                              <input placeholder="Enter numero" id="numeroAgent" type="text" class="form-control" name="numeroAgent" required autofocus>
                          </div>
                      </div>
                      <div class="form-group">
                          <label for="name" class="col-md-4 control-label">Nom Agent</label>
                          <div class="col-md-6">
                              <input placeholder="Enter nom" id="nomAgent" type="text" class="form-control" name="nomAgent" required autofocus>
                          </div>
                      </div>
                      <div class="form-group">
                          <label for="name" class="col-md-4 control-label">Prenom Agent</label>
                          <div class="col-md-6">
                              <input placeholder="Enter prenom" id="prenomAgent" type="text" class="form-control" name="prenomAgent" required autofocus>
                          </div>
                      </div>
                      <div class="form-group">
                          <label for="name" class="col-md-4 control-label">Email</label>
                          <div class="col-md-6">
                              <input placeholder="Enter your email" id="email" type="email" class="form-control" name="email" required autofocus>
                          </div>
                      </div>
                      <div class="form-group">
