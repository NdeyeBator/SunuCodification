    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center>SUPPRESSION AGENT</center></strong></div>
                <div class="panel-body">
                  @foreach( $agents as $agent)
                    <form class="form-horizontal" method="DELETE" action="{{ route('agents.destroy', '$agent->numeroAgent') }}">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <button type="submit" class="btn btn-danger">
                                    Supprimer l'agent {{ $agent->numeroAgent }}
                                </button>
                            </div>
                        </div>
                    </form>
