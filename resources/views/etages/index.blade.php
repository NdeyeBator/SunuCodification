        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i>Table List Etages</i> </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Creation des etages</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td>{{$etage->numeroEtage}}</td>
																					@if($etage->batiment)
																					<td>{{$etage->batiment->nomBatiment}}</td>
																					@endif
																					<td>
																						<a class="btn btn-success" href="{{route('etages.show', $etage->id)}}">  Show </a>
																						<a class="btn btn-warning" href="{{route('etages.edit', $etage->id)}}">  Edit </a>
                    ...
                    <a class="btn btn-info" href="{{ route('etages.create') }}">
                         Add new etage
                    </a>
