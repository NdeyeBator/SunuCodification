    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION DES SITES</center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('sites.store') }}">
                      {{ csrf_field() }}
                     ...
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         ...
                         <input placeholder="Enter location" id="localisation" type="text" class="form-control" name="localisation" value="{{ old('localisation') }}" required autofocus>
                         </div>
                     </div>
                   </div>
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('sites.index')}}" type="button"> Back</a>
