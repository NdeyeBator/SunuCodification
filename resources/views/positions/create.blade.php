    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION DES POSITIONS</center></strong></div>
                  ...
                  <form class="form-horizontal" method="POST" action="{{ route('positions.store') }}">
                     ...
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         ...
                         <input placeholder="Enter description" id="description" type="text" class="form-control" name="description" value="{{ old('description') }}" required autofocus>
                         </div>
                     </div>
                   </div>
                      ...
                      <div class="col-md-4"></div>
                     <div class="col-md-6">
											 <label for="sel1">Select Chambre</label>
											 <select class="form-control" id="" name="chambre_id">
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('positions.index')}}" type="button"> Back</a>
