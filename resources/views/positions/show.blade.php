      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  <div class="panel-heading"><strong><center> Show Batiments</center></strong></div>
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                          ...
                          <h4><strong><u>Description:</u></strong>
                      ...
                      <div class="form-group">
                          ...
                          <h4><strong><u>Chambre:</u></strong>

                           {{$position->chambre->numeroChambre}}</h4>
                      ...
                      <div class="col-md-4">
                      <a class="btn btn-info btn-lg" href="{{ route('positions.index') }}"> Back</a>
                    </div>
