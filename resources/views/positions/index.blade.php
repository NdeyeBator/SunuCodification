        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i>Table List Positions</i> </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Creation des positions</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	<td>{{$position->id}}</td>
																					...
																					@if($position->chambre)
																					<td>{{$position->chambre->numeroChambre}}</td>
																					@endif
																					@if($position->batiment)
																					<td>{{$position->batiment->nomBatiment}}</td>
																					@endif
                                        	<td>
																						<a class="btn btn-success" href="{{route('positions.show', $position->id)}}"> Show </a>
																						<a class="btn btn-warning" href="{{route('positions.edit', $position->id)}}">  Edit </a>
