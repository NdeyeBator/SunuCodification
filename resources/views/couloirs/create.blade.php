    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION DES COULOIRS</center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('couloirs.store') }}">
                      {{ csrf_field() }}
                     ...
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         ...
                         <input placeholder="Enter numero" id="numeroCouloir" type="text" class="form-control" name="numeroCouloir" value="{{ old('numeroCouloir') }}" required autofocus>
                         </div>
                     </div>
                   </div>
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('couloirs.index')}}" type="button"> Back</a>
            @if($errors->has(0))
