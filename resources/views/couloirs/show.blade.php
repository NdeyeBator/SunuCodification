      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  <div class="panel-heading"><strong><center> Show Couloirs</center></strong></div>
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                          ...
                          <h4><strong><u>Numero couloir :</u></strong>

                          {{ $couloir['numeroCouloir']}}</h4>
                      ...
                      <div class="form-group">
                          ...
                          {{ $couloir->batiment->nomBatiment}}</h4>
                      ...
                      <div class="col-md-4">
                      <a class="btn btn-info btn-lg" href="{{ route('couloirs.index') }}"> Back</a>
                    </div>
