        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i>Table List Couloirs</i> </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Creation des couloirs</h3>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	<td>{{ $couloir-> id}}</td>
                                        	<td>{{$couloir->numeroCouloir}}</td>
																					@if($couloir->batiment)
																					<td>{{$couloir->batiment->nomBatiment}}</td>
																					@endif
																					@if($couloir->etage)
																					<td>{{$couloir->etage->numeroEtage}}</td>
																					@endif
																					<td>
																						<a class="btn btn-success" href="{{route('couloirs.show', $couloir->id)}}">  Show </a>
																						<a class="btn btn-warning" href="{{route('couloirs.edit', $couloir->id)}}">  Edit </a>
                    ...
                    <a class="btn btn-info" href="{{ route('couloirs.create') }}">
                         Add new couloir
                    </a>
