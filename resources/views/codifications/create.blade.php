    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> Codification </center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('codifications.store') }}">
                      {{ csrf_field() }}
                      ...
                      <label >Date Debut</label>
   										<div class="ui left icon input">
   											...
   											<input placeholder="Enter date Debut" id="dateDebut" type="date" class="form-control" name="dateDebut" value="{{ old('dateDebut') }}" required autofocus>
   											</div>
   									</div>
   								</div>
                  <div class="form-group">
                 ...
                 <div class="col-md-6">
                   ...
                   <div class="ui left icon input">
                     <i class="write icon"></i>
                     <input placeholder="Enter date Fin" id="dateFin" type="date" class="form-control" name="dateFin" value="{{ old('dateFin') }}" required autofocus>
                     </div>
                 </div>
               </div>
                      ...
                      <div class="col-md-4"></div>
                     <div class="col-md-6">
                       <label for="sel1">Select Etudiant</label>
                       <select class="form-control" id="" name="etudiant_id">
                    ...
                    <select class="form-control" id="" name="position_id">
                      ...
                      @foreach($positions as $position)
                          <option  value="{{ $position->id }}" >
                            ...
                            {{ $position->description }} - {{$position->chambre->numeroChambre}} - {{ $position->chambre->batiment->nomBatiment}}
                          </option>
                      @endforeach
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('codifications.index')}}" type="button"> Back</a>
