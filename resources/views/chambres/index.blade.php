        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i>Table List Chambres</i> </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Creation des chambres</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td>{{ $chambre->numeroChambre}}</td>
																					...
																					@if($chambre->couloir)
																					<td>{{$chambre->couloir->numeroCouloir}}</td>
																					@endif
																					@if($chambre->etage)
																					<td>{{$chambre->etage->numeroEtage}}</td>
																					@endif
																					@if($chambre->batiment)
																					<td>{{$chambre->batiment->nomBatiment}}</td>
																					@endif
																					<td>
																						<a class="btn btn-success" href="{{route('chambres.show', $chambre->id)}}">  Show </a>
																						<a class="btn btn-warning" href="{{route('chambres.edit', $chambre->id)}}">  Edit </a>
                    ...
                    <a class="btn btn-primary" href="{{ route('chambres.create') }}">
                         Add new chambre
                    </a>
