      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  <div class="panel-heading"><strong><center> Show Chambres</center></strong></div>
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                          ...
                          <h4><strong><u>Numero Chambre:</u></strong>

                          {{ $chambre['numeroChambre']}}</h4>

                      </div>
                      <div class="form-group">

                          <h4><strong><u>Capacite:</u></strong>
                      ...
                      <div class="form-group">
                          ...
                          <h4><strong><u>Couloir:</u></strong>

                           {{$chambre->couloir->numeroCouloir}}</h4>

                      </div>
                      <div class="form-group">

                          <h4><strong><u>Etage:</u></strong>

                           {{$chambre->etage->numeroEtage}}</h4>

                      </div>
                      <div class="form-group">

                          <h4><strong><u>Batiment:</u></strong>

                           {{$chambre->batiment->nomBatiment}}</h4>
                      ...
                      <div class="col-md-4">
                      <a class="btn btn-info btn-lg" href="{{ route('chambres.index') }}"> Back</a>
                    </div>
