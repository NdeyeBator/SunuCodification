    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION DES CHAMBRES</center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('chambres.store') }}">
                      {{ csrf_field() }}
                     ...
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         ...
                         <input placeholder="Enter numero" id="numeroChambre" type="text" class="form-control" name="numeroChambre" value="{{ old('numeroChambre') }}" required autofocus>
                         </div>
                     </div>
                   </div>
									 <div class="form-group">
									...
									<div class="col-md-6">
										<div class="ui left icon input">
											<i class="write icon"></i>
											<input placeholder="Enter capacity" id="capacite" type="text" class="form-control" name="capacite" value="{{ old('capacite') }}" required autofocus>
											</div>
									</div>
								</div>
                      <div class="form-group">
                      <div class="col-md-4"></div>
                     <div class="col-md-6">
											 <label for="sel1">Select couloir</label>
											 <select class="form-control" id="" name="couloir_id">

												 @foreach($couloirs as $couloir)
    												 <option  value="{{ $couloir->id }}" >

                               {{ $couloir->numeroCouloir }}
                             </option>
												 @endforeach
                   ...
                   <div class="col-md-4"></div>
                  <div class="col-md-6">
                    <label for="sel1">Select etage</label>
                    <select class="form-control" id="" name="etage_id">
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('chambres.index')}}" type="button"> Back</a>
