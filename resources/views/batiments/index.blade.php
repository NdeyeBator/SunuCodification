        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i>Table List Batiments</i> </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Creation des batiments</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>{{$batiment->dateCreation}}</td>
																					@if($batiment->site)
																					<td>{{$batiment->site->id}}</td>
																					@endif
                                        	<td>
																						<a class="btn btn-success" href="{{route('batiments.show', $batiment->id)}}">  Show </a>
																						<a class="btn btn-warning" href="{{route('batiments.edit', $batiment->id)}}">  Edit </a>
                    ...
                    <a class="btn btn-primary" href="{{ route('batiments.create') }}">
                         Add new batiment
                    </a>
