      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  <div class="panel-heading"><h4> Fiche Batiments</h4></div>
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                          ...
                          {{ $batiment['nomBatiment']}}</h4>

                      </div>
                      <div class="form-group">

                          <h4><strong><u>Date Creation:</u></strong>

                          {{ $batiment['dateCreation']}}</h4>

                      </div>
                      <div class="form-group">

                          <h4><strong><u>Localisation:</u></strong>

                           {{$batiment->site->localisation}}</h4>
                ...
                <a class="btn btn-info btn-lg" href="{{ route('batiments.index') }}"> Back</a>
            </div>
            </div>
            </div>
