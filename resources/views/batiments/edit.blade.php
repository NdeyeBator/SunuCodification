      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                  <div class="panel-heading"><strong><center> Edit Batiment</center></strong></div>
                  ...
                  <div class="panel-body">
                    ...
                    @endif
                    <form  class="form-horizontal" method="PUT" action="{{ route('batiments.update','$batiment->id' ) }}">
                      <div class="form-group">
                      <div class="col-md-4"></div>
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         <i class="write icon"></i>
                         <input placeholder="Enter nom" id="nomBatiment" type="text" class="form-control" name="nomBatiment" value="{{ $batiment->nomBatiment }}" required autofocus>
                         </div>
                     </div>
                   </div>
                   <div class="form-group">
