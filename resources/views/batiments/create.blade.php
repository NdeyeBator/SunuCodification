    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> CREATION DES BATIMENTS</center></strong></div>

                <div class="panel-body">
                  <form class="form-horizontal" method="POST" action="{{ route('batiments.store') }}">
                      {{ csrf_field() }}
                     ...
                     <div class="col-md-6">
                       <div class="ui left icon input">
                         ...
                         <input placeholder="Enter nom" id="nomBatiment" type="text" class="form-control" name="nomBatiment" value="{{ old('nomBatiment') }}" required autofocus>
                         </div>
                     </div>
                   </div>
									 <div class="form-group">
									...
									<div class="col-md-6">
										<div class="ui left icon input">
											<i class="write icon"></i>
											<input placeholder="Enter date" id="dateCreation" type="date" class="form-control" name="dateCreation" value="{{ old('dateCreation') }}" required autofocus>
											</div>
									</div>
								</div>
                      <div class="form-group">
                     ...
                     <div class="col-md-6">
											 ...
											 <select class="form-control" id="" name="site_id">
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('batiments.index')}}" type="button"> Back</a>
