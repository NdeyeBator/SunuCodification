    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong><center> Procedures de Reservation</center></strong></div>
                    ...
                    <select class="form-control" id="" name="chambre_id">
                      ...
                      @foreach($chambres as $chambre)
                          <option  value="{{ $chambre->id }}" >
                            ...
                            {{ $chambre->numeroChambre }} - {{$chambre->batiment->nomBatiment}}
                          </option>
                      @endforeach
            ...
            <a class="btn btn-danger  btn btn-lg" href="{{route('reservations.index')}}" type="button"> Back</a>
